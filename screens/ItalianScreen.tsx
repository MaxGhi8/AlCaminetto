				...
				<View className="space-y-6">
					...
					<View className="flex-1 w-full">
						<TouchableOpacity
							...
							onPress={() => navigation.navigate("HamburgerItalian" as never)}>
							<ImageBackground
					...
					<View className="flex-1 w-full">
						<TouchableOpacity
							className="relative w-full rounded-2xl h-44 bg-[#1A1A1A] border-[0.5px] border-[#333]"
							onPress={() => navigation.navigate("DessertItalian" as never)}>
							<ImageBackground
								className="absolute w-full h-full opacity-40 rounded-2xl"
					...
					<View className="flex-1 w-full">
						<TouchableOpacity
							className="relative w-full rounded-2xl h-44 bg-[#1A1A1A] border-[0.5px] border-[#333]"
							onPress={() => navigation.navigate("DrinkItalian" as never)}>
							<ImageBackground
								className="absolute w-full h-full opacity-40 rounded-2xl"
								source={SfondoDrink}
								imageStyle={{ borderRadius: 16 }}
					...
					<View className="flex-1 w-full mb-6">
						<TouchableOpacity
							className="relative w-full rounded-2xl h-44 bg-[#1A1A1A] border-[0.5px] border-[#333]"
							onPress={() => navigation.navigate("WineItalian" as never)}>
							<ImageBackground
								className="absolute w-full h-full opacity-40 rounded-2xl"
