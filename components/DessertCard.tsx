...
import {BunetImage,
		...
		MeringaImage, 
		TiramisuImage, 
		GelatoFragoleImage} from "../assets";
	...
	return (
		<View className="mt-3 flex-1 w-full rounded-lg px-3 border-2 border-[#292929] bg-[#1A1A1A] drop-shadow-xl">
			<View className="flex-1 flex-row pt-2">
				<Image source={images[photo]} className="items-center justify-center" style={{
													width: windowWidth,
													height: windowWidth,
													borderRadius: 10,
													maxWidth: 200, }} />
				<View className="flex-1 flex-col pl-5">
					<View className="pt-1 items-center justify-center">
						<Text className="text-white font-bold text-xl">
							{title}	
						</Text>
					</View>
					<View className="flex-1 pt-1 items-start justify-center">
						<Text className="flex-1 text-white">
							{description}
						</Text>
					</View>
					<View className="pb-1 justify-end items-end">
